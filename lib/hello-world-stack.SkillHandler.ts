...
const CloudFactIntentHandler: Alexa.RequestHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'CloudFactIntent';
    },
    handle(handlerInput) {
        const category = Alexa.getSlotValue(handlerInput.requestEnvelope, "category");

        const speakOutput = `Here's your ${category} fact`;
...
export const handler: Alexa.LambdaHandler = Alexa.SkillBuilders.custom()
    .addRequestHandlers(
        LaunchRequestHandler,
        HelpIntentHandler,
        CloudFactIntentHandler,
